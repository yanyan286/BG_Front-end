...
#### 1、设计勋章墙
> 本产品的勋章墙主要是结合用户比价的次数、比价产品的种类、连续参与比价的天数所给予的一个综合性评价，用户可以通过在本平台参与各种不同类型产品的价格比较达到10次（天）、50次（天）、100次（天）分别可获得铜牌、银牌以及金牌各类勋章。勋章墙可以在个人资料中展现出来，让用户产生比价的成就感。
#### 2、设立经验等级系统
> 本产品还有等级体系，一方面是为了提升用户活跃，增加留存，粘住用户，另一方面也是为了度量每个用户在产品中的成长过程和价值，便于分群运营。我们选择模仿腾讯QQ的等级系统，一个星星代表一级，五个星星融合变成一个月亮，五个月亮转变成一个地球，五个地球在等于一个太阳。为了激励用户，我们还会设置奖励机制，每升一级就会有不同的奖励（优惠券），等级越高，所拥有的特权就越多。     
用户可以通过每天的签到来获取经验值，邀请新用户也能得到大量的经验值还有每一次的成功比价、团购以及评价等都有经验值的增加。
#### 3、活动
> 比购APP会同步各大平台的活动，；例如：双十一、双十二、六一八购物节等等。同步他们的商品折扣信息，同时我们也会有本平台自身的活动，可以通过参加活动来获取优惠券、经验值、稀有勋章等礼品 
...
- “ **什么值得买** ”： “什么值得买”网站创建于2010年6月，从成立开始便致力于解决消费过程中的信息不对称问题，如今已成为集导购、媒体、工具、社区属性于一体的消费内容社区。
- “ **慢慢买** ”： 主要针对京东，苏宁等电商的价格进行实时跟踪，并进行提醒，当用户有网购需求时，把相对应的需求提交在用户需求栏，软件将自动推送商品给用户，而且商品是各个平台上最优惠的，供用户选购。

#### （二）竞品对照

||什么值得买|慢慢买|
|--|--|--|
|核心功能|跨境电商，直播带货，推荐算法，热门排行| 追踪提醒，自动推送商品给有需求的用户，查看走势|
...
### （五）前端产品信息设计
#### 功能流程图
![功能流程图](https://images.gitee.com/uploads/images/2021/0708/000822_711a14ac_5329225.png "屏幕截图.png")
#### 产品架构图
![产品架构图](https://images.gitee.com/uploads/images/2021/0708/001034_e3b39180_5329225.png "屏幕截图.png")